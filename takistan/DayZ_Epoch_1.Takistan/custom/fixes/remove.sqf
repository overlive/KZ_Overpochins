	...
	if(!isNull(_obj)) then {
		...
		if (_isMine) then {
			if((random 100) <= 5) then {
				_gems = ["ItemTopaz","ItemTopaz","ItemTopaz","ItemTopaz","ItemTopaz","ItemTopaz","ItemTopaz","ItemTopaz","ItemTopaz","ItemTopaz","ItemObsidian","ItemObsidian","ItemObsidian","ItemObsidian","ItemObsidian","ItemObsidian","ItemObsidian","ItemSapphire","ItemSapphire","ItemSapphire","ItemSapphire","ItemSapphire","ItemSapphire","ItemAmethyst","ItemAmethyst","ItemAmethyst","ItemAmethyst","ItemEmerald","ItemEmerald","ItemEmerald","ItemCitrine","ItemCitrine","ItemRuby"];
