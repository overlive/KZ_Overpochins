...
if (!isDedicated) then {
	...
	fnc_usec_selfActions =			compile preprocessFileLineNumbers "custom\fixes\fn_selfActions.sqf";						//Checks which actions for self
	fnc_usec_unconscious =			compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_unconscious.sqf";
	player_temp_calculation	=		compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_temperatur.sqf";			//Temperature System	//TeeChange
	...
	world_surfaceNoise =		compile preprocessFileLineNumbers "custom\fixes\fn_surfaceNoise.sqf";
	...
	player_craftItem =			compile preprocessFileLineNumbers "custom\fixes\player_craftItem.sqf";
	...
	player_wearClothes = 		compile preprocessFileLineNumbers "custom\clothes_fix\player_wearClothes.sqf"; //Switch clothes duping fix
	...
	Schwedes_flashlight = compile preprocessFileLineNumbers "custom\flashlight\flashlight.sqf";	
	...
	local_lockUnlock =			compile preprocessFileLineNumbers "custom\fixes\local_lockUnlock.sqf";		//When vehicle is local to unit perform locking vehicle
