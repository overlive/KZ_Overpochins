...
class playerStatusGUI {
        ...
        class ControlsBackground {
            ...
            {
                idc = 1901;
                text = "\z\addons\custom\gui\status\status_bg.paa";
            ...
            {
                idc = 1201;
                text = "\z\addons\custom\gui\status\status_food_border_ca.paa";
                x = 0.905 * safezoneW + safezoneX;
                y = 0.93 * safezoneH + safezoneY;//2
                w = 0.075;
                h = 0.10;
            ...
            {
                idc = 1200;
                text = "\z\addons\custom\gui\status\status_blood_border_ca.paa";
                x = 0.875 * safezoneW + safezoneX;
                y = 0.93* safezoneH + safezoneY; //3
                w = 0.075;
                h = 0.10;
            ...
            {
                idc = 1202;
                text = "\z\addons\custom\gui\status\status_thirst_border_ca.paa";
                x = 0.935 * safezoneW + safezoneX;
                y = 0.93 * safezoneH + safezoneY; //1
                w = 0.075;
                h = 0.10;
            ...
            {
                idc = 1208;
                text = "\z\addons\custom\gui\status\status_temp_outside_ca.paa";
                x = 0.845 * safezoneW + safezoneX;
                y = 0.93 * safezoneH + safezoneY; //3
                w = 0.075;
                h = 0.10;
            ...
            {
                idc = 1203;
                text = "\z\addons\custom\gui\status\status_effect_brokenleg.paa";
        ...
        class Controls {
            ...
            {
                idc = 1301;
                //text = "\z\addons\custom\gui\status\status_food_inside_ca.paa";
                x = 0.905 * safezoneW + safezoneX;
                y = 0.93 * safezoneH + safezoneY;
                w = 0.075;
                h = 0.10;
            ...
            {
                idc = 1300;
                //text = "\z\addons\custom\gui\status\status_blood_inside_ca.paa";
                x = 0.875 * safezoneW + safezoneX;
                y = 0.93 * safezoneH + safezoneY;
                w = 0.075;
                h = 0.10;
            ...
            {
                idc = 1302;
                //text = "\z\addons\custom\gui\status\status_thirst_inside_ca.paa";
                x = 0.935 * safezoneW + safezoneX;
                y = 0.93 * safezoneH + safezoneY;
                w = 0.075;
                h = 0.10;
            ...
            {
                idc = 1306;
                //text = "\z\addons\custom\gui\status\status_temp_ca.paa";
                x = 0.845 * safezoneW + safezoneX;
                y = 0.93 * safezoneH + safezoneY;
                w = 0.075;
                h = 0.10;
            ...
            {
                idc = 1303;
                text = "\z\addons\custom\gui\status\status_bleeding_ca.paa";
                x = 0.875 * safezoneW + safezoneX;
                y = 0.93 * safezoneH + safezoneY;
                w = 0.075;
                h = 0.10;
            ...
            {
                idc = 1304;
                text = "\z\addons\custom\gui\status\status_noise.paa";
                x = 0.960 * safezoneW + safezoneX;
                y = 0.825 * safezoneH + safezoneY;
                w = 0.075;
                h = 0.10;
            ...
            {
                idc = 1305;
                text = "\z\addons\custom\gui\status\status_visible.paa";
                x = 0.960 * safezoneW + safezoneX;
                y = 0.875 * safezoneH + safezoneY;
                w = 0.075;
                h = 0.10;
