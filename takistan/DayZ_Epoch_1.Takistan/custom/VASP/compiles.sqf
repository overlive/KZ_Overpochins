...
if (!isDedicated) then {
	...
	if (DZE_ConfigTrader) then {
		call compile preprocessFileLineNumbers "\z\addons\compile\player_traderMenuConfig.sqf";
	}else{
		call compile preprocessFileLineNumbers "\z\addons\compile\player_traderMenuHive.sqf";
	};
	*/
	// trader menu code
	if (DZE_ConfigTrader) then {
