...
_item = _this;
if(_item in ["Skin_Bandit1_DZ","Skin_Bandit2_DZ","Skin_BanditW1_DZ","Skin_BanditW2_DZ","Skin_GUE_Soldier_MG_DZ","Skin_GUE_Soldier_Crew_DZ","Skin_GUE_Soldier_CO_DZ","Skin_GUE_Soldier_2_DZ","Skin_Ins_Soldier_GL_DZ"]) exitWith { DZE_ActionInProgress = false; cutText["You are not allowed to wear that skin.","PLAIN DOWN"]; };
call gear_ui_init;
